...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new io.swagger.v3.oas.models.info.Info().title("SESACTON API")
                        .description("SESACTON API LIST")
                        .version("0.0.1"))
                ...
                .servers(Arrays.asList(
                        ...
                        new io.swagger.v3.oas.models.servers.Server().url("http://3.34.118.97:8080").description("Test Server"),
